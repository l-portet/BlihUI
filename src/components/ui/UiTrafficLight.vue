<template>
  <div class="ui-traffic-light no-drag" v-show="!hideTrafficLight">
    <div data-type="close" @click.prevent="close"></div>
    <div data-type="min" @click.prevent="minimize"></div>
    <div data-type="fullscreen" @click.prevent="maximize"></div>
  </div>
</template>
